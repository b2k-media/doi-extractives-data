  ...
  <section class="container" style="position: relative;">
    ...
    <section id="bedeutung" style="position: relative;">
      ...
      <p>
        ...
        <sup class="padding-right">
          <a href="#sub-2">
            {% t recycling.abfallaufkommen_und_verwertung.sup2.title %}
          </a>
        </sup>          
      ...
      <p>
        {% t recycling.beispielefuer_recycling_und_einsatzquoten.p1 %}
        <sup class="padding-right">
          <a href="#sub-5">
            {% t recycling.beispielefuer_recycling_und_einsatzquoten.sup5.title %}
          </a>
        </sup>
        {% t recycling.beispielefuer_recycling_und_einsatzquoten.p1_1 %}
        <sup class="padding-right">
          <a href="#sub-6">
            {% t recycling.beispielefuer_recycling_und_einsatzquoten.sup6.title %}
          </a>
        </sup>
        {% t recycling.beispielefuer_recycling_und_einsatzquoten.p1_2 %}
        <sup class="padding-right">
          <a href="#sub-7">
            {% t recycling.beispielefuer_recycling_und_einsatzquoten.sup7.title %}
          </a>
        </sup>
        {% t recycling.beispielefuer_recycling_und_einsatzquoten.p1_3 %}
        <br>
        {% t recycling.beispielefuer_recycling_und_einsatzquoten.p2%}
        <sup class="padding-right">
          <a href="#sub-8">
            {% t recycling.beispielefuer_recycling_und_einsatzquoten.sup8.title %}
          </a>
        </sup>
        {% t recycling.beispielefuer_recycling_und_einsatzquoten.p2_1%}
        <sup class="padding-right">
          <a href="#sub-9">
            {% t recycling.beispielefuer_recycling_und_einsatzquoten.sup9.title %}
          </a>
        </sup>
      ...
      <ul>
        ...
        <li>{% t recycling.beispielefuer_recycling_und_einsatzquoten.li2%}
            <sup class="padding-right">
              <a href="#sub-10">
                {% t recycling.beispielefuer_recycling_und_einsatzquoten.sup10.title %}
              </a>
            </sup>
            {% t recycling.beispielefuer_recycling_und_einsatzquoten.li2_1%}
            <sup class="padding-right">
              <a href="#sub-11">
                {% t recycling.beispielefuer_recycling_und_einsatzquoten.sup11.title %}
              </a>
            </sup>
            {% t recycling.beispielefuer_recycling_und_einsatzquoten.li2_2%}
        </li>
        <li>{% t recycling.beispielefuer_recycling_und_einsatzquoten.li3%}
            <sup class="padding-right">
              <a href="#sub-12">
                {% t recycling.beispielefuer_recycling_und_einsatzquoten.sup12.title %}
              </a>
            </sup>
            {% t recycling.beispielefuer_recycling_und_einsatzquoten.li3_1%}
        </li>
      </ul>
      <br>
      ...
      <h2 id="rolle_des_gesetzgebers">
        ...
        {% t recycling.ausblick.p1_1 %}
        <sup class="padding-right">
          <a href="#sub-19">
            {% t recycling.ausblick.sup19.title %}
          </a>
        </sup>
